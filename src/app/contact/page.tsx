...
export default function ContactPage() {
  return (
    <PageWrapper forceDarkNav pageName="Contact">
      {/* Contact Section — 2-column layout like Hybrid Mind */}
      <section
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-start">
            ...
            >
              ...
              <h1
                className="font-display text-4xl sm:text-5xl md:text-6xl font-extrabold leading-[1.08] mb-8"
              ...
              >
                We help Malaysian SMEs eliminate manual work through smart automation — no commitment, no technical knowledge required. Tell us where you&apos;re losing time.
              </p>
